...
Rectificar la imagen y transformar las coordenadas 2D de las imágenes obtenidas por la cámara a coordenadas 3D, este proceso se realiza mendiante las matrices de proyección, se consigue triangular triangular la posición de cada punto.
